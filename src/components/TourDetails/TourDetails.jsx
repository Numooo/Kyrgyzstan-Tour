...
const sonkul = {
    ...
    inclusions: [
        ...
        {item: "Guide"},
        {item: "Yurt Stay"},
        {item: "Horseback Riding (optional)"},
        {item: "Meals not listed"},
    ],
    exclusions: [
        {item: "Personal expenses"},
                    ...
                    <div className="mt-4 md:flex md:flex-col items-start gap-5">
                        ...
                        <div className="flex flex-col space-y-2 pt-1">
                            {tour.inclusions.map((item, index) => (
                                <div key={index}
                                     className="flex items-baseline text-gray-700 text-sm sm:text-base gap-1 px-3">
                                    <svg
                                        width="15"
                                        height="15"
                                        viewBox="0 0 22 22"
                    ...
                    <div className="mt-4 md:flex md:flex-col items-start gap-5">
                        ...
                        <div className="flex flex-col space-y-2 pt-1 px-3">
                            {tour.exclusions.map((item, index) => (
                                <div key={index}
                                     className="flex items-baseline text-gray-700 text-sm sm:text-base gap-1">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="12" cy="12" r="10" stroke="#d06b02" stroke-width="2" fill="none"/>
                                        <path d="M16 8L8 16M8 8L16 16" stroke="#d06b02" stroke-width="2"
                ...
                >
                    <div className="relative z-10">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="mt-1">
                                <p className="text-[#55c20c] text-xl font-bold">
                                    1 person - {tour.days * 250}$ <br/>
                                    2-4 people - {tour.days * 200}$ per person <br/>
                                    5+ people - {tour.days * 150}$ per person <br/>
                                </p>
                            </div>
                        </div>
                    </div>
                    <motion.button
                        ...
                        onClick={() => {
                            ...
                            const message = `Hi, I want to reserve this tour: ${tour.title}`;
