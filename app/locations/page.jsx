...
const Locations = () => {
    ...
    const activeCards = activeIndexes.map(index => locations[index].title);
    ...
    return (
        <div className="relative min-h-screen overflow-hidden">
            <div
                className="fixed inset-0 bg-cover bg-center transition-opacity duration-1000 -z-10"
                ...
                <div className="md:container m-auto md:mt-0 px-5 flex justify-center flex-wrap md:gap-10">
                    {locations.map((card, index) => (
                        <div
                            ...
                            className={`md:w-1/4 mb-4 md:mb-0 w-full py-3 h-fit rounded-2xl relative border-2 transition-all duration-300 cursor-pointer ${
                                activeIndexes.includes(index)
                                    ? "border-white bg-white/20 backdrop-blur-sm"
                                    : "border-black bg-white/5"
                            }`}
                        >
