...
export default function UpdatePage() {
    ...
    useEffect(() => {
        ...
        if (isTourPage) void getByIdTour(id);
    }, [id, isSocialPage, isCarPage, isLocationPage, isTourPage]);
            ...
            <div
                            ...
                            <div className="flex gap-10 items-start">
                                ...
                                <div className="flex flex-col gap-2 max-h-52 pr-5 overflow-y-auto">
                                    ...
                                    <button
                                        ...
                                        className="mt-2 w-fit px-3 py-1 bg-blue-600 text-white rounded-md text-sm hover:bg-blue-700"
                                    >
                                        + Добавить локацию
                                    </button>
                                </div>
                ...
                {isLocationPage && (
                    <>
                        ...
                        <div className="mb-4">
                            <div className="flex gap-10 items-center">
                                <label className="block mb-1 w-1/5 md:w-1/10 text-sm md:text-base">Сложность:</label>
                                <input
                                    value={difficulty}
                                    placeholder={"Easy"}
                        ...
                        <div className="mb-4">
                            <div className="flex gap-10 items-center">
                                <label className="block mb-1 w-1/5 md:w-1/10 text-sm md:text-base">Количество:</label>
                                <input
                                    value={groupSize}
                                    placeholder={"from 1 to 10 persons"}
